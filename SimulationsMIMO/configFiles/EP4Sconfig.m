...
dataEP.numberFrames=10;  %number of words transmitted per simulation
...
%EP inner iterations
    ...
    dataEP.flagEPiterations=1; %If 1, same value, in dataEP.EPiterations will be used for all. 
    %This value must be set in dataEP.EPiterations when calling mainEP
    %approaches
    
 %outer iterations (turbo = IDD) 
 dataEP.numberTurbo=3; % number of turbo iterations. If no turbo (standalone
...
dataEP.channelName='1_025'; %Just to save results
