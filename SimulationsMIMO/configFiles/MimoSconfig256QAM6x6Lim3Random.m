...
dataEP.numberSimulations=4; %number of diferent simulations, or average using MC
...
dataEP.numberAntennas=[6 6]; %not used if equalization, but should not be empty 
...
dataEP.numberChannels=10;  %number of random channels. If channel_h is not empty
