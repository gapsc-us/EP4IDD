...
load ../ResultsMIMO/Results256QAMLim3RandomN256/BERvsSNRdBN256256QAMMIMO16x64Lim3RandomFr100
kk=10;
...
load ../ResultsMIMO/Results256QAMLim3RandomN512/BERvsSNRdBN512256QAMMIMO16x64Lim3RandomFr100
kk=10;
semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v--b'),hold on
% semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^--b') %,'color',mycolor)
semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d--','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3RandomN1024/BERvsSNRdBN1024256QAMMIMO16x64Lim3RandomFr100
kk=10;
semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-.b'),hold on
%semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^-.b') %,'color',mycolor)
semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-.','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3RandomN2048/BERvsSNRdBN2048256QAMMIMO16x64Lim3RandomFr100
kk=10;
semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v:b'),hold on
%semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^:b') %,'color',mycolor)
semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d:','color',mycolor1)
...
semilogy(SNRdBSoft,BER_soft_DBEPAproxNeuman_turbo(kk,:),'p:','color',mycolor2),
%
load ../ResultsMIMO/Results256QAMLim3RandomN4096/BERvsSNRdBN4096256QAMMIMO16x64Lim3RandomFr100
kk=10;
semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-b'),hold on
%semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^-b') %,'color',mycolor)
semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-','color',mycolor1)
...
legend('LMMSE','EP-IC','BEP','DEP','DEP-GS',...'LMMSE-GS',
