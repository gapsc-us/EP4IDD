...
load ../ResultsMIMO/Results256QAMLim3RandomN64800/BERvsSNRdBN64800256QAMMIMO16x64Lim3Long25RandomFr20.mat
...
% semilogy(SNRdBSoft,BER_soft_DBEPAproxPCG_turbo(kk,:),'+--','color',mycolor2)
 ...
 set(0, 'DefaultLineLineWidth', 1.1);
load ../ResultsMIMO/Results256QAMLim3RandomN64800/BERvsSNRdBN64800256QAMMIMO16x64Lim3Long33RandomFr20.mat
...
% semilogy(SNRdBSoft,BER_soft_DBEPAproxPCG_turbo(kk,:),'+--','color',mycolor2)
 ...
 load ../ResultsMIMO/Results256QAMLim3RandomN64800/BERvsSNRdBN64800256QAMMIMO16x64Lim3Long5RandomFr20.mat
...
% semilogy(SNRdBSoft,BER_soft_DBEPAproxPCG_turbo(kk,:),'+--','color',mycolor2)
 semilogy(SNRdBSoft,BER_soft_DBEPAproxNeuman_turbo(kk,:),'p--','color',mycolor2), 
  ...
  load ../ResultsMIMO/Results256QAMLim3RandomN64800/BERvsSNRdBN64800256QAMMIMO16x64Lim3Long75RandomFr20.mat
...
%   load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdBN64800256QAMMIMO16x64Lim3Long8RandomFr100
%  %kk=10;
%  semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-b'),hold on
%   semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'>-b') %,'color',mycolor)
%   semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-','color',mycolor1)
...
%  semilogy(SNRdBSoft,BER_soft_DBEPAproxNeuman_turbo(kk,:),'p-','color',mycolor2), 
 ...
 %%%%%%%%%%%PLOT DETAILS
  ...
  legend('LMMSE','LMMSE-GS','EP-IC','BEP','DEP','DEP-GS',...
  'DEP-NSE','Location','SouthWest')%, ...
...
nameFig=[folderName,pbm,'BERvsEbN0LongRates',num2str(dataEP.M),modName,'Lim',num2str(dataEP.LLRlim),dataEP.channelName,'Fr',num2str(dataEP.numberFrames*dataEP.numberSimulations/1000),'k'];
