...
load ../ResultsMIMO/Results64QAMLim3RandomS0/BERvsTS064QAMMIMO16x128Lim3RandomFr100



turboAxis=0:dataEP.numberTurbo;
% semilogy(turboAxis,[BER_soft_MMSE(snr),BER_soft_MMSE_turbo(:,snr).'],'o:b')
semilogy(turboAxis,[BER_soft_MMSEAproxPCG(snr),BER_soft_MMSEAproxPCG_turbo(:,snr).'],'v--b'),hold on
semilogy(turboAxis,[BER_soft_DBEPAproxGS(snr),BER_soft_DBEPAproxGS_turbo(:,snr).'],'o--','color',mycolor2),
semilogy(turboAxis,[BER_soft_EPICLMMSE(snr),BER_soft_EPICLMMSE_turbo(:,snr).'],'d-','color',mycolor1)
...
load ../ResultsMIMO/Results64QAMLim3RandomS1/BERvsTS164QAMMIMO16x128Lim3RandomFr100
turboAxis=0:dataEP.numberTurbo;
...
load ../ResultsMIMO/Results64QAMLim3RandomS3/BERvsTS364QAMMIMO16x128Lim3RandomFr100
turboAxis=0:dataEP.numberTurbo;
% semilogy(turboAxis,[BER_soft_MMSE(snr),BER_soft_MMSE_turbo(:,snr).'],'o--b'),hold on
semilogy(turboAxis,[BER_soft_PBEP(snr),BER_soft_PBEP_turbo(:,snr).'],'x--','color',mycolor),
semilogy(turboAxis,[BER_soft_DBEP(snr),BER_soft_DBEP_turbo(:,snr).'],'s--','color',mycolor2),
...
load ../ResultsMIMO/Results64QAMLim3RandomS10/BERvsTS1064QAMMIMO16x128Lim3RandomFr100
turboAxis=0:dataEP.numberTurbo;
% semilogy(turboAxis,[BER_soft_MMSE(snr),BER_soft_MMSE_turbo(:,snr).'],'o-.b'),hold on
semilogy(turboAxis,[BER_soft_PBEP(snr),BER_soft_PBEP_turbo(:,snr).'],'x:','color',mycolor),
semilogy(turboAxis,[BER_soft_DBEP(snr),BER_soft_DBEP_turbo(:,snr).'],'s:','color',mycolor2),
...
%NOTA: 'LMMSE', %=p-BEP S0
legend('MMSE-GS','DEP-GS','EP-IC','BEP S0','DEP S0','BEP S1','DEP S1',...
