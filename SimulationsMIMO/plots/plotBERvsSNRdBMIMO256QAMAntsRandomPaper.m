...
% load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO3x3Lim3RandomFr100.mat
% kk=10;
...
% 
%  semilogy(SNRdBSoft,BER_soft_DBEPAproxPCG_turbo(kk,:),'+-','color',mycolor3)
%  semilogy(SNRdBSoft,BER_soft_DBEPAproxNeuman_turbo(kk,:),'p-','color',mycolor2),
%  
%  return

load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO4x4Lim3RandomFr100.mat
kk=10;
 semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-b'),hold on
%  semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^-b') %,'color',mycolor)
  semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-','color',mycolor1)
...
% load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO6x6Lim3RandomFr100.mat
% kk=10;
%  semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v--b'),hold on
%   semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^--b') %,'color',mycolor)
%   semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d--','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO8x8Lim3RandomFr100.mat
kk=10;
 semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-.b'),hold on
%  semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^-.b') %,'color',mycolor)
  semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-.','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO64x64Lim3RandomFr100.mat
kk=10;
 semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v:b'),hold on
%  semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^:b') %,'color',mycolor)
  semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d:','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdB256QAMMIMO128x128Lim3RandomFr100.mat
kk=10;
 semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v--b'),hold on
 %  semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^--b') %,'color',mycolor)
  semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d--','color',mycolor1)
...
%  semilogy(SNRdBSoft,BER_soft_DBEPAproxNeuman_turbo(kk,:),'p--','color',mycolor2), 
 ...
 legend('LMMSE', ... %'LMMSE-GS',
 'EP-IC','BEP','DEP',...%'DEP-GS',...
 ... % 'DEP-GS','DEP-PCG','DEP-NSE',
  'Location','SouthWest')%, ...
...
nameFig=[folderName,pbm,'BERvsEbN0Ants',num2str(dataEP.M),modName,'Lim',num2str(dataEP.LLRlim),dataEP.channelName,'Fr',num2str(dataEP.numberFrames*dataEP.numberSimulations/1000),'k'];
