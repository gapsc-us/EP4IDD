...
% load ../ResultsMIMO/Results256QAMLim3RandomN256/BERvsSNRdBN256256QAMMIMO128x128Lim3RandomFr100
% 
...
% 
% 
% load ../ResultsMIMO/Results256QAMLim3RandomN512/BERvsSNRdBN512256QAMMIMO128x128Lim3RandomFr100
% 
% semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v--b'),hold on
% % semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^--b') %,'color',mycolor)
% semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d--','color',mycolor1)
...
load ../ResultsMIMO/Results256QAMLim3RandomN1024/BERvsSNRdBN1024256QAMMIMO128x128Lim3RandomFr100
...
load ../ResultsMIMO/Results256QAMLim3RandomN2048/BERvsSNRdBN2048256QAMMIMO128x128Lim3RandomFr100
...
load ../ResultsMIMO/Results256QAMLim3RandomN4096/BERvsSNRdBN4096256QAMMIMO128x128Lim3RandomFr100
...
% 
% load ../ResultsMIMO/Results256QAMLim3Random/BERvsSNRdBN4096256QAMMIMO128x128Lim3RandomFr100
% kk=10;
% semilogy(SNRdBSoft,BER_soft_MMSE_turbo(kk,:),'v-b'),hold on
% %semilogy(SNRdBSoft,BER_soft_MMSEAproxGS_turbo(kk,:),'^-b') %,'color',mycolor)
% semilogy(SNRdBSoft,BER_soft_EPICLMMSE_turbo(kk,:),'d-','color',mycolor1)
...
legend('LMMSE','EP-IC','BEP','DEP'...%'DEP-GS',...'LMMSE-GS','DEP-NSE'
,'Location','SouthWest')%, ...
...
nameFig=[folderName,pbm,'BERvsEbN0Ns',num2str(dataEP.M),modName,'Lim',num2str(dataEP.LLRlim),dataEP.channelName,'Fr',num2str(dataEP.numberFrames*dataEP.numberSimulations/1000),'k'];
