function [x_decod,prob_b,ti,hi_2,nu_qi,nu_piDec,nu_piDecEP]=DBEPalg(A,complexFlag,sigma,y,H,pui_ldpc,nturbo,nu_E,var_E,S_EP)
...
% Created 28/06/2018
%
% Description: This function runs the D-BEP [Santos19] for turbo equalization. 
...
if ~isempty(nu_E)
    ...
    nu_piDec=nu_pi; %First Estimation of the LMMSE
