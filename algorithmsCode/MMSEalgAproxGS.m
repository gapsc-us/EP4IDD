function [x_decod,prob_b,me,Ve]=MMSEalgAproxGS(A,complexFlag,sigma,y,H,pui_ldpc)

% Function: MMSEalgAproxGS
%
% [x_decod,prob_b,me,Ve]=MMSEalgAproxGS(A,complexFlag,sigma,y,H,pui_ldpc)
%
