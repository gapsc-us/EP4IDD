function [x_decod,prob_b,me,Ve]=MMSEalg(A,complexFlag,sigma,y,H,pui_ldpc)

% Function: MMSEalg
%
% [x_decod,prob_b,me,Ve]=MMSEalg(A,complexFlag,sigma,y,H,pui_ldpc)
%
...
% Created 7/03/2017
%
% Description: This function runs the LMMSE [Muranov10] for turbo equalization. 
...
C=(sigma^(-2)*H'*H+diag(GAMMA))\eye(length(GAMMA));
z=C*(sigma^(-2)*H'*y+gamma);
