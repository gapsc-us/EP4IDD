function [x_decod,prob_b,ti,hi_2]=DBEPalgAproxPCG(A,complexFlag,sigma,y,H,pui_ldpc,nturbo,nu_E,var_E)

% Function: DBEPalgAproxPCG
%
% [x_decod,prob_b,ti,hi_2]=DBEPalgAproxPCG(A,complexFlag,sigma,y,H,pui_ldpc,nturbo,nu_E,var_E)
%
...
[nu_qi,~,~,iter] = pcg(K,b,1e-6,Kcg,Phat,Phat');
nu_qi=sigma^(-2)*nu_qi+gamma./GAMMA;
